...
cts <- read.csv("gcount_matrix_Emb_adult.csv", header=TRUE, sep=",", row.names = "ID_REF")
colData <- read.csv("coldata_Emb_adult.csv", header=TRUE, sep=",")
attach(cts)
attach (colData)
...
res <- results(dds, name="Age_Embryonic_vs_Adult")
#or to shrink log fold changes association with condition:
resLFC <- lfcShrink(dds, coef="Age_Embryonic_vs_Adult", type="apeglm")
```
...
write.csv(as.data.frame(res),
          file="Age_EmbryonicVSAdult_results.csv")
...
EnhancedVolcano(res,
    ...
    y = 'pvalue',
    axisLabSize = 12,
    selectLab = c('CNTN1','LUM','TNR','GPC3','GPC4','HMMR','GPC5','GPC6','MMP2','COL3A1','LAMA1','BCAN','SDC1','HAS2','MBP','ADAM23','VCAN','LAMC1','NCAN'),
    title = 'Embryonic vs Adult',
